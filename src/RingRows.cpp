...
namespace Rings {
    ...
    // (the glasses driver will simply ignore out-of-bounds pixels).
    const uint8_t invalidRowIndices[] = {24};
    const Row invalidRow = {invalidRowIndices, sizeof(invalidRowIndices)};
